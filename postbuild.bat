...
set dstPath2=d:\Licenta\Shares\W10x64\temp_share
...
echo Will copy %srcPath1% to %dstPath2%
xcopy  %srcPath1% %dstPath2% /y /e /s
if %errorlevel% NEQ 0 (
    exit %errorlevel%
)

echo Will copy %srcPath2% to %dstPath2%
xcopy  %srcPath2% %dstPath2% /y /e /s
if %errorlevel% NEQ 0 (
    exit %errorlevel%
)
